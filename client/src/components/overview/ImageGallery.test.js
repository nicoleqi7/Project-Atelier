...
describe("ImageGallery", () => {
  it('should render the class of "slideshow-container null" and "prev"', () => {
    const productStyle = {
      product_id: "64622",
      results: [
        {
    ...
    const { container } = render(<ImageGallery productStyle={productStyle} />);
    expect(
      container.getElementsByClassName("slideshow-container null").length
    ).toBe(1);
